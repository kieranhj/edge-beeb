...
| SWRAM slot 5 (`SWRAM_SPRITES0`) | `BANK1`: sprite data, pixel shift 0, then the titles' zoom scroller and its own rupture handler, then the starfield, then a tune stream at `&B900` |
